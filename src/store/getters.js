...
export default {
  ...
  transfersGetter(state, { sortedFlights, filterStatus }) {
    ...
    } return sortedFlights.filter(({ totalTransfers }) => _.includes(filterStatus.transfers, totalTransfers));
  },
  ...
  totalGetter(state, { transfersGetter, priceFromGetter, priceUpToGetter, carriersGetter}) {
